...
"
      >
        {isOpen ? "Fechar Habilidades" : "Abrir Habilidades"}
      </button>
      ...
      >
        <p className="p-4">
          Tenho intensificado meus estudos para aprimorar conhecimentos em:
          HTML, CSS, JavaScript e alguns frameworks e bibliotecas como, SCSS,
          Vite, React e Bootstrap.
        </p>
      </div>
    </div>
  );
